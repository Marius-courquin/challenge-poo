insert into BIEN (ID_BIEN, type_bien, categorie_surface_bien, surface_habitable, nbr_pieces, description_libre, Commentaire_agence, date_creation, date_derniere_maj, ID_ADRESSE, NO_APPARTEMENT, ETAGE)
